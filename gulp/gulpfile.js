...
const srcPath = {
  ...
  js: "../src/js/**/*",
  img: "../src/images/**/*",
  php: ["../src/**/*.php", "!./node_modules/**", "!../src/root/**"],
  rt: "../src/root/**/*",
};
...
const copyRootFiles = () => {
  return src(srcPath.rt, { dot: true }).pipe(dest(destPath.rt));
};
...
// ブラウザシンク付きの開発用タスク
exports.default = series(series(cssSass, jsBabel, imgImagemin, phpCopy, copyRootFiles), parallel(watchFiles, browserSyncFunc));

// 本番用タスク
exports.build = series(clean, cssSass, jsBabel, imgImagemin, phpCopy, copyRootFiles);
