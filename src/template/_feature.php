      ...
      $features = [
        ...
        [
          ...
          'descriptions' => [
            ...
            'サプリメント なお、本サービスは、JADA（公益財団法人日本アンチ・ドーピング機構）が設置した、サプリメント認証枠組み検証有識者会議により発行された<a href="#" target="_blank" rel="noopener noreferrer">「スポーツにおけるサプリメントの製品情報公開の枠組みに関するガイドライン」</a>に準じた運営体制を取っています。'
          ]
        ],
      ];
