...
$mailConfig = array(
  'fromName'=>'ドーピング物質分析事務局',
  'subject'=>'【ドーピング物質分析】お問い合わせを受け付けました',
  'body'=>'
[send_time]に、
ドーピング物質分析へのお問い合わせを受け付けました。
...
$remailConfig = array(
  'fromName'=>'ドーピング物質分析事務局',
  'subject'=>'【ドーピング物質分析】お問い合わせいただきましてありがとうございました。',
  'body'=>'
この度はドーピング物質分析へお問い合わせいただきまして、誠にありがとうございました。以下の内容にて送信いたしました。
...
$htmlRemailConfig = array(
  ...
  'subject'=>'【ドーピング物質分析】お問い合わせいただきましてありがとうございました。',
  'body'=>'
この度はドーピング物質分析へお問い合わせいただきまして、誠にありがとうございました。以下の内容にて送信いたしました。<br>
<br>
