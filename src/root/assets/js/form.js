...
//       $("[name=" + fieldName + "]").before('<div class="error-message">' + message + '</div>');
//   }
...
//       ["applicant_name", "furigana", "email_address", "corporate_name"].forEach(function(field) {
...
//           $("[for=" + considerationField + "]").after('<div class="error-message">必須入力項目です</div>');
//       }

//       // Validate furigana
//       if ($("[name=furigana]").val().match(/[^ぁ-んァ-ンー　\s]+/)) {
//           showErrorMessage("furigana", "ひらがな、またはカタカナで入力してください");
//       }

//       // Validate telephone number
//       var normalizedPhoneNumber = normalizePhoneNumber($("[name=telephone_number]").val());
//       if (normalizedPhoneNumber && !normalizedPhoneNumber.match(/^(0[5-9]0[0-9]{8}|0[1-9][1-9][0-9]{7})$/)) {
